...
ode_field <- function(ode_struct, x, param_, differentials) {
    .Call(`_episode_ode_field`, ode_struct, x, param_, differentials)
}

aim_design <- function(ode_struct, opt_struct, sc_, x, param_) {
    .Call(`_episode_aim_design`, ode_struct, opt_struct, sc_, x, param_)
}
...
#'
#' @export
numint <- function(time, x, type, A, B) {
    .Call(`_episode_numint`, time, x, type, A, B)
}

bull <- function(ode_struct, opt_struct, sc_, params_, x0s, trace = FALSE) {
    .Call(`_episode_bull`, ode_struct, opt_struct, sc_, params_, x0s, trace)
}

cattle <- function(ode_struct, opt_struct, sc_, param_, x, trace = FALSE) {
    .Call(`_episode_cattle`, ode_struct, opt_struct, sc_, param_, x, trace)
}

bronc <- function(ode_struct, opt_struct, sc_, params_, x0s, indices, adjust_lambda, adjust_scales, adjust_weights, trace = FALSE) {
    .Call(`_episode_bronc`, ode_struct, opt_struct, sc_, params_, x0s, indices, adjust_lambda, adjust_scales, adjust_weights, trace)
}

ode_solve <- function(ode_struct, x0, param_, time, sensitivity, approx) {
    .Call(`_episode_ode_solve`, ode_struct, x0, param_, time, sensitivity, approx)
}
